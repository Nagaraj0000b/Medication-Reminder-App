  ...
  return (
    <div className="bg-white rounded-xl shadow p-6">
      <div className="flex justify-between items-center mb-4">
        ...
        <button className="text-sm text-blue-600 underline" onClick={onViewAll}>
          View All
        </button>
      </div>
      <ul className="divide-y divide-gray-100">
        {medications.length === 0 && (
          <li className="py-4 text-gray-400 text-center">No medications with reminders for this day.</li>
        )}
        {medications.map(med => (
